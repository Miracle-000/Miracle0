...
let achpage = document.getElementsByClassName('achpage')

let mute = 0


let ach1 = new Image()
ach1.src = "media/ach1.bmp"


let ach2 = new Image()
ach2.src = "media/ach2.bmp"


let ach3 = new Image()
ach3.src = "media/ach3.bmp"

for (let o = 0; o < achpage.length; o++) {
    achpage[o].onclick = () => {
        fw.style.display = 'flex'
        fw.style.top = body.scrollTop + 'px'
        body.style.overflow = 'hidden'
        box.innerHTML = `<img src="${achpage[o].src}" alt="">`
    }
}
...
noise.addEventListener('click', muted)
